    ...
    <main className="flex min-h-screen bg-[#102a28] md:bg-[#f7f0f0] text-white md:text-[#102a28] relative overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col md:flex-row relative">
        ...
        <motion.section 
          ...
          className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24 z-10 py-32 md:py-20"
        >
          <div className="space-y-8 max-w-2xl">
             <div className="flex items-center gap-4">
              <div className="h-[1px] w-12 bg-white/20 md:bg-brand-dark/20" />
              <TreePine className="size-6 text-white/30 md:text-brand-dark/30" />
              <span className="text-[10px] font-bold tracking-[0.5em] text-white/60 md:text-brand-dark/60 uppercase">
                Od 1978 roku
              </span>
            </div>

            <h1 className="font-serif text-5xl font-bold tracking-tight text-white md:text-[#102a28] md:text-6xl">
              O nas
            </h1>

            <div className="space-y-6 text-white/80 md:text-[#102a28]/80 leading-relaxed text-lg">
              <p>
            ...
            <div className="flex gap-6 pt-4">
              <div className="flex size-10 items-center justify-center rounded-full border border-white/20 md:border-[#102a28]/20 text-white/40 md:text-[#102a28]/40 transition-all hover:border-white/40 md:hover:border-[#102a28]/40 hover:text-white md:hover:text-[#102a28] cursor-pointer">
