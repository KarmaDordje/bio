...
export function ContactClient() {
  return (
    <main className="flex min-h-screen bg-[#102a28] md:bg-brand-cream overflow-x-hidden text-white md:text-brand-dark relative">
      ...
      <div className="flex-1 flex flex-col md:flex-row relative">
        ...
        >
          <h1 className="font-serif text-5xl md:text-6xl font-bold mb-6 mt-12 md:mt-0">
            Zapraszamy <br />
            <span className="font-script text-brand-green/80 text-6xl lowercase">do kontaktu</span>
          </h1>
          <p className="text-sm text-white/60 md:text-brand-dark/60 max-w-sm leading-relaxed">
        ...
        <section className="w-full md:w-[50%] bg-[#102a28] relative flex flex-col justify-center px-12 md:px-20 text-white min-h-[500px] py-20">
